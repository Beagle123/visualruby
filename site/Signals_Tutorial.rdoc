...
This assumes that you have a button in your glade form names "button1".  Then visualruby
...
There's no need to assign signal handlers in glade, or use Gtk's #signal_connect() method.
